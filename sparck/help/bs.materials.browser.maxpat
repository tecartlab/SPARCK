...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 658.0, 34.0, 20.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.0, 620.0, 50.0, 18.0 ],
					"text" : "rebuild"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 560.0, 50.0, 85.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 586.0, 611.0, 69.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 586.0, 588.0, 136.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 721.0, 51.0, 173.333328, 131.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.5, 592.0, 76.0, 32.0 ],
					"text" : ";\rmax refresh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 300.5, 560.0, 265.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 300.5, 530.5, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 149.0, 109.0, 256.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, -3.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.5, 443.0, 220.0, 88.5 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 286.0, 88.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 213.5, 64.0, 150.0, 20.0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "thumbnail.view.maxpat",
				"bootpath" : "/Applications/Max6.1.4/Cycling '74/interfaces",
				"patcherrelativepath" : "../../../../../../../../../../../../Applications/Max6.1.4/Cycling '74/interfaces",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
