...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.tfm.node.1.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 306.0, 101.0, 180.0, 131.0 ],
					"varname" : "TfmNode",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "we", "transform", "@text", "transform", "@hint", "parent transformation" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 306.0, 43.0, 202.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "transform", "@types", "anim", "@out1", "anim", "@outoff1", "anim", "@out2", "anim_tree_nodes", "><", "@outoff2", "<root>", "@out3", "adapt", "><", "@outoff3", 0, "@offname", "<none>", "@description", "parent transformation", "@text", "parent", "@hint", "parent transformation" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 50.0, 43.0, 200.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 54.5, 404.0, 623.0, 127.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.5, 265.0, 161.0, 22.0 ],
...
,
					"patching_rect" : [ 54.5, 358.0, 286.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.5, 265.0, 73.0, 22.0 ],
					"text" : "namespace"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 64.0, 309.5, 331.0, 309.5 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				...
				"patcherrelativepath" : "../../patchers/nodes/transform",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
