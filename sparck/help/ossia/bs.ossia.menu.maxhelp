...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 158.0, 15.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 7.0, 127.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "my_model", "menuint", "@type", "int", "@text", "lens", "@hint", "load model file", "@size", 150, 19, "@items", "fov", "fristum", "gestrum", "guntrum", "fov_ortho", "frustum_ortho" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 50.0, 514.0, 623.0, 127.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 375.0, 161.0, 22.0 ],
...
,
					"patching_rect" : [ 50.0, 468.0, 286.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 408.0, 35.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 59.5, 419.5, 326.5, 419.5 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
