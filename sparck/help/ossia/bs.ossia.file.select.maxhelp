...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 175.0, 805.0, 275.0 ],
					"text" : "parmeterName\n@pathtype <string> path type (ie. absolute, boot, C74, ignore, relative)\n@pathstyle <string> path style (i.e. colon, max, native, native_win, slash)\n@cmdRead <string> command prepended when choosing a file\n@cmdSaveAs <string> command prepended when choosing saveAs\n@cmdSave <string> command when choosing 'save'\n@fileExtension <string> file extension when saving a file\n@relativePath <string (starts without /)> project-path/relativePath -> where the files are\n@text <string> the text shown as a descriptor\n@hint <string> the hint of the text\n@description <string> the description of the ossia parameter\n@depth <int> the depth of subfolder to be shown\n@types <selectable file types>\n@setable <0/1(default)> sets if the selected menu item can be set\n@readOnly <0(default)/1> sets if the set item can be saved \n@messageOnSelect <string> sets the message that is send when select... is selected\n@textSelect <string> sets the select text\n@readAgain <0/1(default)>: when readagain = 0 -> it will only select a file that doesnt match the previously selected. \n@cmdReset <string(default = 'reset')> defines the inlet command that sets the selector back to select (and subsequently sends the messageonselect)\n@fileWatch <0(default)/1> when set to 1 it will trigger another fileName command if the file was altered in the meanwhile."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 50.0, 607.0, 623.0, 127.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 468.0, 161.0, 22.0 ],
...
,
					"patching_rect" : [ 50.0, 561.0, 286.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 468.0, 73.0, 22.0 ],
					"text" : "namespace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 527.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 50.0, 42.0, 208.083373999999992, 21.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 59.5, 501.5, 326.5, 501.5 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
