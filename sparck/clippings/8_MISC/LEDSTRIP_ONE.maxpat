...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.pop.ledstrip.one.1.maxpat",
					"numinlets" : 1,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 210.0, 103.0 ],
					"varname" : "LedStripOne",
					"viewvisibility" : 1
				}
		...
		"parameters" : 		{
			...
			"obj-1::obj-99::obj-10::obj-72" : [ "toggle[1]", "toggle", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bs.node.pop.ledstrip.one.maxpat",
...
, 			{
				"name" : "bs.node.pop.ledstrip.properties.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "bs.node.pop.ledstrip.body.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "bs.node.pop.ledstrip.unique.js",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
