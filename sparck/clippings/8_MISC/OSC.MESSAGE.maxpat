...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.net.osc.message.1.maxpat",
					"numinlets" : 2,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 181.0, 74.0 ],
					"varname" : "OscMessage",
					"viewvisibility" : 1
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "bs.node.net.osc.message.maxpat",
...
, 			{
				"name" : "bs.node.net.osc.message.properties.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "bs.node.net.osc.message.properties.filter.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
