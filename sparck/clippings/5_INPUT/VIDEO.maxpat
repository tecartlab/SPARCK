...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.tex.moovie.1.maxpat",
					"numinlets" : 1,
					"numoutlets" : 4,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
...
,
		"dependency_cache" : [ 			{
				"name" : "bs.node.tex.moovie.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/textures",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "bs.node.tex.moovie.properties.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/textures",
				"type" : "JSON",
				"implicit" : 1
			}
