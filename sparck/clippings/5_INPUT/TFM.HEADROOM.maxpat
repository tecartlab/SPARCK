...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.tfm.headRoom.1.maxpat",
					"numinlets" : 2,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 180.0, 104.0 ],
					"varname" : "TfmHeadRoom",
					"viewvisibility" : 1
				}
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-3::obj-1::obj-47::obj-19::obj-72" : [ "toggle", "toggle", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bs.node.tfm.headRoom.maxpat",
...
, 			{
				"name" : "bs.node.tfm.HeadRoom.properties.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/transform",
				"type" : "JSON",
				"implicit" : 1
			}
