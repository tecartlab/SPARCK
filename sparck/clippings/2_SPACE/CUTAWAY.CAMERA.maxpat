...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.camera.cutaway.1.maxpat",
					"numinlets" : 1,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 0.0, 0.0, 180.0, 162.0 ],
					"varname" : "CutCamera",
					"viewvisibility" : 1
				}
...
, 			{
				"name" : "bs.node.camera.cutaway.1.properties.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/3Dee",
				"patcherrelativepath" : "../../patchers/nodes/3Dee",
				"type" : "JSON",
				"implicit" : 1
