...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.shader.spatial.softedge.1.maxpat",
					"numinlets" : 4,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 180.0, 269.0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "bs.node.shader.spatial.softedge.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/fx",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "bs.math.matrix.multi.js",
...
, 			{
				"name" : "bs.node.shader.spatial.softedge.properties.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/fx",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "bs.util.dyn.soft.beamer.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/utils",
				"type" : "JSON",
				"implicit" : 1
			}
