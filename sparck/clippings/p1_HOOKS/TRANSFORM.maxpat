...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.hook.tfm.1.maxpat",
					"numinlets" : 1,
					"numoutlets" : 3,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 0.0, 0.0, 180.0, 131.0 ],
					"varname" : "TransformHook_1",
					"viewvisibility" : 1
				}
		...
		"dependency_cache" : [ 			{
				"name" : "bs.node.hook.tfm.1.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/misc",
				"patcherrelativepath" : "../../patchers/nodes/misc",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
