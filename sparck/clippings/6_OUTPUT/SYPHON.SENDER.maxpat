...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.tex.syphon.server.1.maxpat",
					"numinlets" : 2,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 0.0, 180.0, 65.0 ],
					"varname" : "SyphonSender",
					"viewvisibility" : 1
				}
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-3::obj-28::obj-47::obj-19::obj-72" : [ "toggle", "toggle", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bs.node.tex.syphon.server.maxpat",
