...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "bs.node.shader.tex.colormap.1.maxpat",
					"numinlets" : 3,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 0.0, 0.0, 180.0, 81.0 ],
					"varname" : "ShdrColormap",
					"viewvisibility" : 1
				}
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-27::obj-47::obj-19::obj-72" : [ "toggle", "toggle", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bs.node.shader.tex.colormap.maxpat",
...
, 			{
				"name" : "bs.node.shader.tex.colormap.properties.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
