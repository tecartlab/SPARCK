...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 277.5, 288.0, 157.0, 37.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 281.0, 206.0, 154.0, 37.0 ],
					"style" : "",
					"text" : "Hover your mouse over the file selection"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.5, 262.0, 180.0, 82.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 118.5, 181.0, 180.0, 82.0 ],
					"varname" : "Model_node",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 381.0, 415.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.5, 265.251617, 415.0, 20.0 ],
					"style" : "",
					"text" : "The model nodes for example expects the files inside ~/_assets/_models"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 444.0, 490.0, 65.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 17.5, 302.0, 498.0, 65.0 ],
					"style" : "",
					"text" : "An easy way to get your files into the correct asset-folder is to drag'n drop the file over the file selection. This will create a copy of the file inside the asset folder and the node will to load it if the format is compatible. However, it is important that the project is saved in order to have this work reliably."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 111.0, 496.0, 94.0 ],
					"presentation" : 1,
					"presentation_linecount" : 6,
					"presentation_rect" : [ 17.5, 64.0, 498.0, 94.0 ],
					"style" : "",
					"text" : "Before you start creating nodes and patch and link them together, you should created a new Project. Many nodes need files, and SPARCK requires them to be located inside a specific folder structure (see below). \n\nIf you need to know where the node expects the file, just hover your mousepointer over the file selection and a hint will tell you which folder is used:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 81.0, 823.0, 279.0, 233.6625 ],
					"pic" : "ProjectStructureAssetsModels.png",
					"presentation" : 1,
					"presentation_rect" : [ 113.5, 688.0, 301.0, 252.087494 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 85.0, 636.0, 275.0, 99.6875 ],
					"pic" : "ProjectStructureSmall.png",
					"presentation" : 1,
					"presentation_rect" : [ 113.5, 488.0, 301.0, 109.1125 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 754.0, 497.0, 50.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 17.5, 613.0, 495.0, 50.0 ],
					"style" : "",
					"text" : "All folders (and their subfolders) that start with a _ (underscore) are needed by SPARCK and should neither be renamed nor moved. But you can create your own folders if you want to structure your assets:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 1387.0, 522.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 528.0, 500.0, 94.0 ],
					"presentation" : 1,
					"presentation_linecount" : 6,
					"presentation_rect" : [ 17.5, 382.0, 500.0, 94.0 ],
					"style" : "",
					"text" : "A SPARCK project is ideally located inside its own folder: when you create a new project, SPARCK will create inside the same folder the aformentioned structure in which it will store all the needed assets for the project. This way a project can be easily copied to another machine without missing anything. (though it is possible to used shortcuts or symbolic-links with some nodes, it is for this reason not recommended)"
				}
