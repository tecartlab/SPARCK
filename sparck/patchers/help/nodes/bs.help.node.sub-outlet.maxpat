...
, 			{
				"box" : 				{
					"args" : [ "sub-outlet", "NodeReference", "bs.vpl.node.util.subnode.outlets.1.maxpat" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"name" : "bs.vpl.node.util.subnode.outlets.1.maxpat",
