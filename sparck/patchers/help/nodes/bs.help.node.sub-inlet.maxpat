...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 495.0, 517.0, 114.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 378.0, 517.0, 114.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "sub-inlet", "NodeReference", "bs.vpl.node.util.subnode.inlets.1.maxpat" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 256.0, 517.0, 118.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1182.0, 522.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 613.0, 168.0, 23.0 ],
					"rounded" : 10.0,
					"style" : "",
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-1::obj-35::obj-4::obj-72" : [ "toggle", "toggle", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "bs.help.util.node.head.maxpat",
...
, 			{
				"name" : "bs.vpl.node.util.subnode.inlets.1.maxpat",
...
, 			{
				"name" : "bs.vpl.subnode.iolets.js",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/javascript/vpl",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
				"name" : "bs.node.gui.button.delete.png",
