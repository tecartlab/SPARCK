...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.5, 1177.0, 312.0, 31.0 ],
					"presentation_rect" : [ 60.5, 1177.0, 312.0, 31.0 ],
					"style" : "",
					"text" : ";\rmax launchbrowser http://heroicrobotics.boards.net/board/6/updates"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.5, 1152.0, 261.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 358.5, 1186.0, 131.0, 23.0 ],
					"rounded" : 10.0,
					"style" : "",
					"text" : "PixelPusher updates",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.5, 1113.0, 372.0, 31.0 ],
					"presentation_rect" : [ 60.5, 1113.0, 372.0, 31.0 ],
					"style" : "",
					"text" : ";\rmax launchbrowser http://heroicrobotics.boards.net/thread/22/pixelpusher-ledstrip"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.5, 1088.0, 261.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 172.5, 1186.0, 182.0, 23.0 ],
					"rounded" : 10.0,
					"style" : "",
					"text" : "LedStrips with different lengths",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 0,
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textovercolor" : [ 1.0, 1.0, 1.0, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.5, 1053.0, 313.0, 31.0 ],
					"presentation_rect" : [ 60.5, 1053.0, 313.0, 31.0 ],
					"style" : "",
					"text" : ";\rmax launchbrowser http://heroicrobotics.boards.net/thread/63/thread"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.5, 1028.0, 261.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 1186.0, 157.0, 23.0 ],
					"rounded" : 10.0,
					"style" : "",
					"text" : "Howto Flash a PixelPusher",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textjustification" : 0,
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textovercolor" : [ 1.0, 1.0, 1.0, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 1252.0, 517.0, 114.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 717.0, 517.0, 464.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "PixelPusher", "p", "PropertyReference" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 548.0, 517.0, 164.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "PixelPusher", "n", "NodeReference" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 256.0, 517.0, 285.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 1412.0, 522.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1412.0, 522.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.5, 1273.0, 231.0, 31.0 ],
					"presentation_rect" : [ 60.5, 1273.0, 231.0, 31.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 60.5, 1248.0, 261.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 1370.0, 168.0, 23.0 ],
					"rounded" : 10.0,
					"style" : "",
