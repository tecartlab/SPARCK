...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.5, 456.5, 100.0, 75.0 ],
					"pic" : "CubeMap_example.jpg",
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 258.5, 517.0, 372.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 947.0, 517.0, 114.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 810.0, 517.0, 130.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "CubeMap", "p", "PropertyReference" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 636.5, 517.0, 164.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 1135.0, 522.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1108.0, 522.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 1065.0, 168.0, 23.0 ],
					"rounded" : 10.0,
...
, 			{
				"name" : "bs.props.CubeMap.p.maxpat",
