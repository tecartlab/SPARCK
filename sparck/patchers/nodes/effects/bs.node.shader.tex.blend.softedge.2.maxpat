...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 665.008605999999986, 171.0, 29.5, 20.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.959350999999998, 210.403808999999995, 272.0, 20.0 ],
					"text" : "bs.node.shader.tex.blend.softedge.2.properties @window 1",
					"varname" : "property"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 516.008605999999986, 406.692383000000007, 54.508606, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 72.875, 54.0, 28.25, 16.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 590.008605999999986, 286.0, 29.5, 20.0 ],
					"text" : "t b l"
				}
...
,
					"patching_rect" : [ 346.555542000000003, 56.0, 219.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 481.333312999999976, 435.692383000000007, 225.0, 22.0 ],
...
,
					"patching_rect" : [ 318.555542000000003, 128.403808999999995, 29.5, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.833312999999976, 84.0, 49.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 53.0, 49.0, 18.0 ],
					"text" : "enable >"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 329.055542000000003, 84.0, 17.807617, 17.807617 ],
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 54.0, 13.0, 13.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 318.555542000000003, 162.403808999999995, 47.0, 20.0 ],
					"text" : "gate 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 481.333312999999976, 411.192383000000007, 16.5, 16.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 819.0, 69.903808999999995, 89.0, 22.0 ],
					"text" : "loadmess 0.62"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 780.5, 38.070435000000003, 35.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 816.5, 38.070435000000003, 46.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 869.5, 38.070435000000003, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 766.0, 95.903808999999995, 52.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 819.0, 95.903808999999995, 46.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 873.0, 95.903808999999995, 147.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 159.055556999999993, 134.0, 57.0, 22.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 152.0, 262.070434999999975, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 12.944443, 262.070434999999975, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 255.0, 262.070434999999975, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 89.0, 333.0, 169.666672000000005, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 306.305542000000003, 365.0, 54.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 665.008605999999986, 138.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 162.875, 56.875, 13.125, 13.125 ]
				}
...
,
					"patching_rect" : [ 590.008605999999986, 249.0, 120.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 7.0, 137.903808999999995, 23.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"blendluminance" : [ 0.620000004768372 ],
						"blendpower" : [ 2.0 ],
						"enable" : [ 0 ],
						"renderOne" : [ 0 ]
					}
...
, 			{
				"box" : 				{
					"args" : [ "#1", "#2", "#3", "#4", "title", "BlendSoftedge", "@logo", "power", "@properties", 1, "@help", "BlendSoftedge" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 3.444458, 131.903808999999995, 178.555542000000003, 36.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 338.555542000000003, 113.509521000000007, 404.055542000000003, 113.509521000000007 ],
					"order" : 2,
					"source" : [ "obj-24", 0 ]
				}
