...
, 			{
				"box" : 				{
					...
					"enablehscroll" : 0,
					"enablevscroll" : 0,
					"hint" : "Save next frame to ~/_export/_textures/<nodename>.png",
					"id" : "obj-40",
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 523.801270000000045, 433.807616999999993, 54.508606, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 122.375, 114.0, 28.25, 16.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 593.5, 251.807616999999993, 36.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 33.0, 36.0, 18.0 ],
					"text" : "mode"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 917.0, 177.0, 49.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 93.0, 49.0, 18.0 ],
					"text" : "outoffset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 907.388793999999962, 121.0, 64.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 73.0, 48.0, 18.0 ],
					"text" : "in2offset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 895.0, 70.0, 64.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 92.0, 53.0, 48.0, 18.0 ],
					"text" : "in1offset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 651.888793999999962, 172.0, 48.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 93.0, 48.0, 18.0 ],
					"text" : "outscale"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.388793999999962, 121.0, 65.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 73.0, 47.0, 18.0 ],
					"text" : "in2scale"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.388793999999962, 70.0, 63.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -0.0625, 53.0, 47.0, 18.0 ],
					"text" : "in1scale"
				}
...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"fontsize" : 9.0,
					"hint" : "operand mode {/sparck/node ::<nodename>::mode <string>}",
					"id" : "obj-69",
					"items" : [ "mult", ",", "add", ",", "sub", ",", "div", ",", "mod", ",", "min", ",", "max", ",", "abs", ",", "avg", ",", "absdiff", ",", "and", ",", "or", ",", "xor", ",", "not", ",", "gt", ",", "lt", ",", "gte", ",", "lte", ",", "eq", ",", "neq", ",", "gtp", ",", "ltp", ",", "gtep", ",", "ltep", ",", "eqp", ",", "neqp", ",", "sin", ",", "cos", ",", "tan", ",", "asin", ",", "acos", ",", "atan", ",", "atan2", ",", "sinh", ",", "cosh", ",", "tanh", ",", "asinh", ",", "acosh", ",", "atanh", ",", "exp", ",", "exp2", ",", "ln", ",", "log2", ",", "log10", ",", "hypot", ",", "pow", ",", "sqrt", ",", "ceil", ",", "floor", ",", "fract", ",", "normsin", ",", "normcos" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 647.888793999999962, 251.807616999999993, 81.0, 19.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 33.0, 131.0, 19.0 ],
					"varname" : "mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 678.888793999999962, 278.807616999999993, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 812.388793999999962, 29.640868999999999, 62.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 833.388793999999962, 194.0, 73.0, 22.0 ],
					"text" : "outoffset $1"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"format" : 6,
					"hint" : "outpute texture offset {/sparck/node ::<nodename>::outoffset <float>}",
					"id" : "obj-18",
					"maxclass" : "flonum",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 833.388793999999962, 172.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 143.3887939453125, 93.0, 36.0, 19.0 ],
					"varname" : "outoffset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 833.388793999999962, 143.0, 72.0, 22.0 ],
					"text" : "in2offset $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 833.388793999999962, 92.0, 65.0, 22.0 ],
					"text" : "inoffset $1"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"format" : 6,
					"hint" : "input texture two offset {/sparck/node ::<nodename>::in2offset <float>}",
					"id" : "obj-50",
					"maxclass" : "flonum",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 833.388793999999962, 121.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 143.3887939453125, 73.0, 36.0, 19.0 ],
					"varname" : "in2offset"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"format" : 6,
					"hint" : "input texture one offset {/sparck/node ::<nodename>::in1offset <float>}",
					"id" : "obj-51",
					"maxclass" : "flonum",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 833.388793999999962, 70.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 143.3887939453125, 53.0, 36.0, 19.0 ],
					"varname" : "in1offset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 719.388793999999962, 194.0, 72.0, 22.0 ],
					"text" : "outscale $1"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"format" : 6,
					"hint" : "outpute texture scale {/sparck/node ::<nodename>::outscale <float>}",
					"id" : "obj-55",
					"maxclass" : "flonum",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 719.388793999999962, 172.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 93.0, 36.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 719.388793999999962, 143.0, 71.0, 22.0 ],
					"text" : "in2scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 719.388793999999962, 92.0, 64.0, 22.0 ],
					"text" : "inscale $1"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"format" : 6,
					"hint" : "input texture two scale {/sparck/node ::<nodename>::in2scale <float>}",
					"id" : "obj-44",
					"maxclass" : "flonum",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 719.388793999999962, 121.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 73.0, 36.0, 19.0 ],
					"varname" : "in2scale"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"format" : 6,
					"hint" : "input texture one scale {/sparck/node ::<nodename>::in1scale <float>}",
					"id" : "obj-63",
					"maxclass" : "flonum",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 719.388793999999962, 70.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 53.0, 36.0, 19.0 ],
					"varname" : "in1scale"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 112.0, 49.0, 18.0 ],
					"text" : "enable >"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 57.5, 114.0, 13.0, 13.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 700.388793999999962, 29.640868999999999, 62.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 551.008605999999986, 11.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 107.0625, 115.0, 13.125, 13.125 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 166.055556999999993, 190.0, 95.0, 22.0 ],
									"text" : "prepend shader"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 166.055556999999993, 226.070435000000003, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 240.055556999999993, 118.070435000000003, 57.0, 22.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 278.055542000000003, 190.0, 88.0, 22.0 ],
									"text" : "prepend name"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 278.055542000000003, 226.070435000000003, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 51.999996000000003, 242.0, 169.666672000000005, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 91.9375, 115.0, 13.125, 13.125 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 156.0, 23.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.5, 268.807616999999993, 62.0, 20.0 ],
					"text" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 6.444458, 195.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#1", "#2", "#3", "#4", "title", "TextureOP", "@logo", "power", "@properties", 0, "@help", "TextureOP" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 6.444458, 150.0, 178.555542000000003, 36.0 ],
					"presentation" : 1,
