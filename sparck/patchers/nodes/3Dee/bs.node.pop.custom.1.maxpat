...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "native", "boot", "read", "read", "read", "xml", "_models", 1, "@types", "Jdae", "Jobj", "@readonly", 1, "@presentation_size", 159, 10, "@fontsize", 10, "@hint", "read model file {/sparck/node ::<nodename>::model::fileName <string>}" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 237.958313000000004, 107.211303999999998, 166.083373999999992, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 613.444458000000054, 147.0, 52.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.777770999999973, 268.0, 19.0, 20.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 459.194457999999997, 19.0, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 424.777770999999973, 107.211303999999998, 146.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.555542000000003, 219.570435000000003, 49.0, 20.0 ],
					"text" : "enable 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 123.555542000000003, 194.0, 40.0, 20.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 123.555542000000003, 167.211304000000013, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 397.444427000000019, 187.211304000000013, 249.0, 22.0 ],
					"text" : "bs.node.pop.custom.1.properties @window 1",
					"varname" : "property"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.777770999999973, 19.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 290.305542000000003, 325.0, 48.0, 30.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 55.0, 10.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.777771000000001, 325.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "#1", "#2", "#3", "#4", "title", "Model", "@properties", 1, "@logo", "power" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 4.0, 180.0, 57.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 4.0, 180.0, 57.0 ],
					"proportion" : 0.39,
					"varname" : "vpl_canvas"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 133.055542000000003, 157.461304000000013, 406.944427000000019, 157.461304000000013 ],
					"order" : 0,
					"source" : [ "obj-19", 2 ]
				}
...
, 			{
				"name" : "bs.node.pop.custom.1.properties.maxpat",
