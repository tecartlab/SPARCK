...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 347.472351000000003, 192.0, 29.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.777892999999949, 107.640868999999995, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 567.333312999999976, 107.640868999999995, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "native", "boot", "read", "saveas", "save", "obj", "_assets/_textures", 2, "@types", "TIFF", "GIFf", "JPEG", "PNG", "@presentation_size", 115, 20, "@fontsize", 9, "@readonly", 1, "@fileWatch", 1, "@hint", "load texture (located in ~/_assets/_textures) {/sparck/node ::<nodename>::texture::fileName <string>}" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 347.472351000000003, 142.772217000000012, 193.0, 21.131592000000001 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 32.0, 134.0, 19.26318359375 ],
					"varname" : "texture",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 541.861023000000046, 183.903808999999995, 53.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 53.26318359375, 40.0, 17.0 ],
					"text" : "default ",
...
, 			{
				"box" : 				{
					"fontsize" : 9.0,
					"hint" : "default image {/sparck/node ::<nodename>::defaultImg <string>}",
					"id" : "obj-88",
					"items" : [ "checker", ",", "black", ",", "white" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 598.194336000000021, 183.903808999999995, 60.0, 19.0 ],
					"pattrmode" : 1,
					"prefix" : "defaultimage",
					"prefix_mode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 46.86102294921875, 52.26318359375, 53.4168701171875, 19.0 ],
					"varname" : "defaultImg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 326.472351000000003, 10.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 100.928878784179688, 52.26318359375, 58.071121215820312, 19.0 ],
					"varname" : "renderpass"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 436.972351000000003, 44.570435000000003, 79.0, 22.0 ],
					"text" : "route refresh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 624.638915999999995, 146.903808999999995, 73.0, 22.0 ],
					"text" : "prepend flip"
				}
...
, 			{
				"box" : 				{
					"hint" : "flip texture {/sparck/node ::<nodename>::property::flip <0/1>}",
					"id" : "obj-45",
					"maxclass" : "toggle",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 598.194336000000021, 146.903808999999995, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 159.535552978515625, 32.0, 19.26318359375, 19.26318359375 ],
					"varname" : "flip"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 547.861023000000046, 146.903808999999995, 30.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 137.0, 32.0, 22.0, 17.0 ],
					"text" : "flip",
					"textcolor" : [ 0.238637998700142, 0.238637998700142, 0.238637998700142, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 496.972351000000003, 75.403808999999995, 59.5, 22.0 ],
					"restore" : 					{
						"defaultImg" : [ "checker" ],
						"enable" : [ 0 ],
						"fileWatch" : [ 0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#1", "#2", "#3", "#4", "title", "Texture", "@properties", 0, "@logo", "power", "@help", "Texture" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
