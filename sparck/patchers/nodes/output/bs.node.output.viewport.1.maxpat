...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 38.370361000000003, 219.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 724.0, 280.5, 65.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 52.0, 29.0, 17.0 ],
					"text" : "slice",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 624.0, 249.0, 65.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 31.5, 41.0, 17.0 ],
					"text" : "window",
					"textcolor" : [ 0.238637998700142, 0.238637998700142, 0.238637998700142, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 258.555542000000003, 404.0, 144.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 439.333405000000027, 212.0, 225.0, 20.0 ],
					"text" : "bs.node.output.viewport.1.properties @window 1",
					"varname" : "property"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 443.305542000000003, 422.0, 108.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 418.305542000000003, 319.0, 110.0, 20.0 ],
					"text" : "jit.gl.node @drawto off"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 286.333312999999976, 11.0, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"fontsize" : 9.0,
					"hint" : "choose ouput viewport colum {/sparck/node ::<nodename>::viewportCol <string>} ",
					"id" : "obj-32",
					"items" : [ "row", 1, ",", "row", 2 ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 639.0, 280.5, 83.0, 19.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 50.0, 69.0, 19.0 ],
					"varname" : "viewportRow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 639.0, 319.0, 83.0, 20.0 ],
					"text" : "prepend selRow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.22222899999997, 319.0, 78.0, 20.0 ],
					"text" : "prepend selCol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 503.0, 370.0, 96.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "bs.node.viewport",
						"parameter_enable" : 0
					}
,
					"text" : "js bs.node.viewport"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 0.0, 159.5, 20.0, 20.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 206.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 149.0, 145.0, 94.0, 22.0 ],
									"text" : "prepend drawto"
								}
...
,
					"patching_rect" : [ 331.333312999999976, 266.0, 74.444457999999997, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.333312999999976, 356.0, 62.0, 20.0 ],
					"text" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 101.0, 33.0, 20.0 ],
					"text" : "done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 38.370361000000003, 101.0, 63.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 258.555542000000003, 212.0, 138.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 459.000061000000017, 11.0, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 186.75, 4.0, 59.5, 20.0 ],
					"restore" : 					{
						"enable" : [ 0 ],
						"viewportCol" : [ "column 1" ],
						"viewportRow" : [ "row 1" ]
					}
,
					"text" : "autopattr",
...
, 			{
				"box" : 				{
					...
					"hint" : "choose ouput viewport colum {/sparck/node ::<nodename>::viewportCol <string>} ",
					"id" : "obj-30",
					"items" : [ "column", 1, ",", "column", 2, ",", "column", 3, ",", "column", 4, ",", "column", 5, ",", "column", 6, ",", "column", 7, ",", "column", 8, ",", "column", 9, ",", "column", 10, ",", "column", 11, ",", "column", 12 ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 548.22222899999997, 280.5, 73.0, 19.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 110.0, 50.0, 69.0, 19.0 ],
					"varname" : "viewportCol"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@types", "output", "@out3", "cols", "@out2", "rows", "@out1", "rendercontext", "drawto", "@presentation_size", 120, 19, "@fontsize", 9, "@hint", "select output window {/sparck/node ::<nodename>::outputSelection::address <string>} " ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 471.936523000000022, 249.0, 140.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 40.0, 29.5, 140.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 369.833373999999992, 11.0, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 431.833405000000027, 11.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 339.055603000000019, 11.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.777771000000001, 11.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "#1", "#2", "#3", "#4", "title", "ViewPort", "@properties", 1, "@help", "ViewPort" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 0.0, 152.5, 150.555542000000003, 37.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 4.0, 180.0, 69.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 4.0, 180.0, 69.0 ],
					"proportion" : 0.39,
					"varname" : "vpl_canvas"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 551.0, 400.0, 632.611084000000005, 400.0, 632.611084000000005, 269.5, 557.72222899999997, 269.5 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 589.5, 400.0, 729.0, 400.0, 729.0, 269.5, 648.5, 269.5 ],
					"source" : [ "obj-21", 2 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-34::obj-58::obj-10::obj-72" : [ "toggle", "toggle", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "bs.node.output.viewport.1.properties.maxpat",
