...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, 85.390868999999995, 23.0, 23.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 12.0, 197.0, 82.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 223.0, 62.0, 20.0 ],
					"text" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.777770999999973, 176.0, 19.0, 20.0 ],
					"text" : "t l",
					"varname" : "inlet"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.777771000000001, 265.0, 66.0, 20.0 ],
					"text" : "prepend text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 99.333313000000004, 197.0, 114.0, 20.0 ],
					"text" : "substitute title fileName"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 216.555542000000003, 126.0, 106.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 164.0, 66.0, 20.0 ],
					"text" : "openpatcher"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 21.0, 135.640869000000009, 42.000014999999998, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 152.0, 32.0, 27.0, 20.0 ],
					"rounded" : 4.0,
					"text" : "open",
					"usebgoncolor" : 1,
					"usetextovercolor" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 99.333313000000004, 317.5, 130.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "bs.node.object.loader",
						"parameter_enable" : 0
					}
,
					"text" : "js bs.node.object.loader #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.249985000000009, 34.0, 33.0, 20.0 ],
					"text" : "done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 99.333313000000004, 349.5, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 327.777739999999994, 4.0, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.555542000000003, 4.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "max", "boot", "loadpatcher", "saveas", "save", "maxpat", "_assets/_patchers", 1, "@types", "JSON", "@readonly", 1, "@presentation_size", 130, 20, "@fontsize", 10, "@readagain", 0, "@hint", "load patcher (located in ~/_assets/_patchers) {/sparck/node ::<nodename>::patcher::fileName <string>}" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 99.333313000000004, 229.0, 140.444457999999997, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 32.0, 153.0, 21.26318359375 ],
					"varname" : "patcher",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 227.277771000000001, 4.0, 59.5, 22.0 ],
					"restore" : 					{
						"enable" : [ 0 ]
					}
,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "#2", "#3", "#4", "title", "Patcher", "@help", "Patcher" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 12.0, 79.140868999999995, 168.0, 34.5 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 2 ],
					"midpoints" : [ 230.277771000000001, 295.0, 3.074066, 295.0, 3.074066, 68.140868999999995, 120.833333333333329, 68.140868999999995 ],
					"source" : [ "obj-8", 0 ]
				}
