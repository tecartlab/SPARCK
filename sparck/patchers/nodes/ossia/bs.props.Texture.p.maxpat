...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "#1", "image/default", "@text", "default", "@items", "checker", "black", "white", "@type", "string", "@size", 179, 18 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int", "", "", "" ],
					"patching_rect" : [ 256.0, 265.0, 208.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 256.0, 230.0, 86.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 40.0, 82.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "#1", "render/pass", "@text", "pass", "@items", "passA", "passB", "passC", "passD", "passE", "passF", "passG", "passH", "passZ", "manualA", "manualB", "manualC", "manualD", "beamer", "@type", "string", "@size", 79, 18 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int", "", "", "" ],
					"patching_rect" : [ 260.0, 161.0, 208.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 425.5, 193.0, 32.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "image/file", "@text", "imagefile", "@size", 139, 19, "@menutype", "file" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int", "", "" ],
					"patching_rect" : [ 256.0, 120.0, 212.0, 19.0 ],
					"presentation" : 1,
