...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.226844999999912, 183.000000000000028, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "image/file", "@pathstyle", "native", "@pathtype", "boot", "@cmdRead", "read", "@cmdSaveAs", "read", "@cmdSave", "read", "@fileExtension", "xml", "@relativePath", "_assets/_textures/_cubemaps", "@depth", 2, "@types", "TIFF", "GIFf", "JPEG", "PNG", "@readonly", 1, "@setable", 1, "@description", "load texture. (drag n' drop -> stored in ~/_assets/_textures/_cubemaps)", "@text", "image", "@messageonselect", "read" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 528.226844999999912, 216.000000000000057, 203.0833740234375, 20.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 240.222168000000011, 158.640869000000009, 104.0, 20.0 ],
...
,
					"patching_rect" : [ 12.499984999999995, 103.570435000000003, 56.666679500000001, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.166664500000003, 150.570435000000003, 62.0, 20.0 ],
					"text" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 240.222168000000011, 263.0, 199.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 240.222168000000011, 111.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 104.722214000000008, 10.0, 63.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.444428000000016, 8.640869000000002, 33.0, 20.0 ],
					"text" : "done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 12.499984999999995, 219.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#0_id", "#1", "#2", "#3", "#4", "title", "CubeMap", "@enable_properties", 1, "@help", "CubeMap", "@enable_body", 1 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 15.666655999999989, 54.000000000000014, 211.0, 37.0 ],
					"presentation" : 1,
