...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.5, 292.0, 92.0, 22.0 ],
					"text" : "prepend hidden"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 143.5, 268.0, 87.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "#1", "indicator/color", "@size", 119, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "list", "", "" ],
					"patching_rect" : [ 14.5, 239.0, 201.0, 23.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.5, 277.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#1", "mirrorplane", "@text", "mirrorplane", "@type", "int", "@size", 179, 19, "@items", "x-y plane", "x-z plane", "y-z plane" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int", "", "", "" ],
					"patching_rect" : [ 274.5, 239.0, 208.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "mode", "@text", "mode", "@type", "int", "@size", 179, 19, "@items", "translation & rotation", "translation only", "rotation only" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "tfm/mirrored", "@text", "mirrored", "@size", 159, 19, "@menutype", "message" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "tfm/mirror", "@text", "mirror", "@size", 159, 19, "@menutype", "message" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.5, 321.0, 26.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 21.0, 159.0, 17.0 ],
