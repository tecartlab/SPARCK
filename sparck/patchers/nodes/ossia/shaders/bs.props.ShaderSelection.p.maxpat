...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "#1", "shader", "@text", "shader", "@items", "depth", "normal", "cylinderGrid" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int", "", "", "" ],
					"patching_rect" : [ 251.0, 99.0, 208.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 242.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 242.0, 23.0 ],
					"proportion" : 0.39,
