...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "#1", "reset", "@uselabeltext", 1, "@onlabeltext", "reset", "@offlabeltext", "reset", "@size", 119, 19, "@mode", 1, "@hint", "reset to default values" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 61.0, 98.0, 17.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#1", "avg_luma", "@text", "avg_luma", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "alpha", "@text", "alpha", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 265.5, 253.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "saturation", "@text", "saturation", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 265.5, 224.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "contrast", "@text", "contrast", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 265.5, 195.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 80.0, 83.0, 20.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "#1", "brightness", "@text", "brightness", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 265.5, 167.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 80.0, 83.0, 20.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 325.5, 311.903809000000024, 407.5, 311.903809000000024, 407.5, 95.903809000000024, 313.5, 95.903809000000024 ],
					"source" : [ "obj-10", 1 ]
				}
