...
,
		...
		"globalpatchername" : "ShaderPointCloud",
		"boxes" : [ 			{
				"box" : 				{
					"id" : "obj-19",
					"maxclass" : "newobj",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 147.777739999999994, 30.999999999999986, 93.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 437.218739333333247, 199.18408203125, 66.0, 22.0 ],
									"text" : "route bang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 386.0, 291.18408203125, 199.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 235.666655999999989, 335.192383000000063, 278.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 259.442686999999978, 100.0, 264.796885666666697, 22.0 ],
...
, 							{
								"box" : 								{
									"args" : [ "parent", "@types", "anim", "@out1", "anim", "@outoff1", "anim", "@out2", "anim_tree_nodes", "><", "@outoff2", "<root>", "@offname", "<none>", "@description", "parent transformation" ],
									"bgmode" : 0,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 282.999989333333247, 173.570434999999975, 183.5, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.777739999999994, 100.0, 89.0, 22.0 ],
									"text" : "prepend ignore"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "bang", "" ],
									"patching_rect" : [ 235.666655999999989, 240.570434999999975, 161.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.888855000000035, 26.999999999999986, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-14", 0 ],
									"midpoints" : [ 387.166655999999989, 275.192383000000063, 507.312489333333474, 275.192383000000063, 507.312489333333474, 155.570434999999975, 292.499989333333247, 155.570434999999975 ],
									"source" : [ "obj-20", 4 ]
								}
...
,
					"patching_rect" : [ 200.259267333333327, 142.815918000000011, 64.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 240.555542000000003, 236.0, 360.0, 31.0 ],
					"text" : "jit.gl.gridshape @shape plane @color 1 1 1 1 @blend_enable 1 @dim 640 480 @poly_mode 2 2 @anim #0.anim.mesh"
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 2108.0, 119.0, 1080.0, 904.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.055479999999989, 181.0, 341.0, 22.0 ],
													"text" : "\"for inverseHue decoding, the distanceMin needs to be >= 0.3\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 50.055479999999989, 155.0, 65.0, 22.0 ],
													"text" : "route error"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.055479999999989, 127.640869000000066, 232.0, 22.0 ],
													"text" : "if $i1 == 3 && $f2 < 0.3 then error else not"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.055479999999989, 100.0, 41.0, 22.0 ],
													"text" : "pak i f"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.055480999999986, 40.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 85.055480999999986, 40.0, 30.0, 30.0 ]
												}
...
,
									"patching_rect" : [ 503.527739999999994, 800.640869000000066, 78.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 358.805542000000003, 767.903809000000024, 106.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 330.055479999999989, 711.0, 102.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 371.555479999999989, 618.640869000000066, 96.0, 20.0 ],
									"text" : "prepend holeDetect"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 366.555479999999989, 553.640869000000066, 93.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "int", "", "" ],
									"patching_rect" : [ 153.0, 93.850646999999981, 800.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 153.0, 61.833373999999992, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 354.555479999999989, 496.640869000000009, 106.0, 20.0 ],
									"text" : "prepend encodeMode"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 354.555479999999989, 429.640869000000009, 69.0, 20.0 ],
									"text" : "prepend focal"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 337.555479999999989, 369.640869000000009, 67.0, 20.0 ],
									"text" : "prepend pOff"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.555479999999989, 345.640869000000066, 75.0, 22.0 ],
									"text" : "prepend dim"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 32.555479999999989, 807.640869000000066, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.555479999999989, 24.0, 79.0, 22.0 ],
									"text" : "r #0_id::reset"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 95.055479999999989, 190.640869000000009, 85.0, 20.0 ],
									"text" : "prepend cullNear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.555479999999989, 61.833373999999992, 35.0, 22.0 ],
									"text" : "reset"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 192.055479999999989, 807.640869000000066, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 240.555542000000003, 108.0, 101.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 283.0, 207.070435000000003, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 138.999984999999981, 207.070435000000003, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 11.944442999999978, 207.070435000000003, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 306.611114999999984, 115.192383000000007, 56.0, 22.0 ],
									"text" : "freebang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 306.611114999999984, 152.0, 45.0, 22.0 ],
									"text" : "texture"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 206.0, 152.0, 95.0, 22.0 ],
									"text" : "prepend shader"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 206.0, 207.070435000000003, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 168.0, 94.070435000000003, 57.0, 22.0 ],
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 59.999984999999981, 152.0, 88.0, 22.0 ],
									"text" : "prepend name"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 59.999984999999981, 207.070435000000003, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 49.592595333333328, 108.0, 169.666672000000005, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 514.683898999999997, 305.807616999999993, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.666671999999977, 305.807616999999993, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.138976999999954, 11.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.555542000000003, 283.307616999999993, 20.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 240.555542000000003, 313.807616999999993, 101.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 240.555542000000003, 351.0, 234.0, 22.0 ],
					"text" : "jit.gl.shader sparck @file bs.pointCloud.jxs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 377.555542000000003, 11.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.259263333333337, 165.0, 62.0, 20.0 ],
					"text" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 58.111114999999998, 13.499999999999996, 63.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.666672000000005, 11.0, 33.0, 20.0 ],
					"text" : "done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 49.592595333333328, 224.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 197.222213999999951, 4.0, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#2", "#4", 2, "texture", 1, "@hint", "texture one (also used for shader)" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 308.333312999999976, 11.0, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.555542000000003, 11.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.666671999999977, 4.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "#0_id", "#1", "#2", "#3", "#4", "title", "ShaderPointCloud", "@enable_properties", 1, "@help", "ShaderPointCloud", "@enable_body", 1 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 5.111129999999977, 42.0, 178.555542000000003, 36.0 ],
					"presentation" : 1,
