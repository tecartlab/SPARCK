...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "#1", "outoffset", "@text", "output offset", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 310.5, 325.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "outscale", "@text", "output scale", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 295.5, 310.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "in2offset", "@text", "in 2 offset", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "in1offset", "@text", "in 1 offset", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 280.5, 295.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "in2scale", "@text", "in 2 scale", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "mode", "@text", "mode", "@items", "mult", "add", "sub", "div", "mod", "min", "max", "abs", "avg", "absdiff", "and", "or", "xor", "not", "gt", "lt", "gte", "lte", "eq", "neq", "gtp", "ltp", "gtep", "ltep", "eqp", "neqp", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "sinh", "cosh", "tanh", "asinh", "acosh", "atanh", "exp", "exp2", "ln", "log2", "log10", "hypot", "pow", "sqrt", "ceil", "floor", "fract", "normsin", "normcos" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 271.0, 106.0, 200.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 81.0, 98.0, 17.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#1", "in1scale", "@text", "in 1 scale", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 265.5, 280.903809000000024, 120.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 80.0, 83.0, 20.0 ],
					"viewvisibility" : 1
				}
