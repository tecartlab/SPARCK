...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 159.798401000000013, 60.59619140625, 183.0, 62.0 ],
									"text" : "ossia.parameter image/default @type string @default checker @range checker black white @description \"default image\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 20.0, 19.0, 380.0, 22.0 ],
									"text" : "ossia.parameter flip @type bool @default 0 @description \"flip texture\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 60.59619140625, 71.0, 22.0 ],
									"text" : "prepend flip"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 159.798401000000013, 129.59619140625, 125.0, 22.0 ],
									"text" : "prepend defaultimage"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 83.899201000000005, 182.59619140625, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 362.194336000000021, 188.640869000000009, 61.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 248.0, 395.929565999999966, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 276.0, 60.894470000000013, 166.0, 116.0 ],
...
,
					"patching_rect" : [ 240.22216796875, 188.640869000000009, 104.0, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.999985000000001, 209.429565000000025, 62.0, 20.0 ],
					"text" : "ossia.model"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 14.0, 47.211304000000013, 127.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 122.0, 83.211304000000013, 58.0, 22.0 ],
									"text" : "route title"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 122.0, 125.0, 75.0, 35.0 ],
									"text" : "prepend name"
								}
...
,
					"patching_rect" : [ 8.999985000000001, 128.0, 56.666679500000001, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.66666450000001, 175.0, 62.0, 20.0 ],
					"text" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 165.666655999999989, 219.0, 29.5, 20.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					"args" : [ "#2", "#4", 2, "texture", "@hint", "image texture" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 240.22216796875, 258.0, 186.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 240.22216796875, 148.570435000000003, 101.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 86.722214000000008, 12.0, 63.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.444428000000016, 10.640869000000002, 33.0, 20.0 ],
					"text" : "done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.999985000000001, 234.570434999999975, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "#0_id", "#1", "#2", "#3", "#4", "title", "Texture", "@enable_properties", 1, "@help", "Texture", "@enable_body", 1 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 2.722214000000001, 57.640868999999995, 211.0, 37.0 ],
					"presentation" : 1,
