...
, 			{
				"box" : 				{
					"args" : [ "#1", "render/texture/dim/size", "dimension" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 220.0, 200.0, 19.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "#1", "tfm", "local transformations:" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				...
				"patcherrelativepath" : "../../ossia/custom/camera",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
