...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "#1", "draw/group", "@text", "drawgroup", "@size", 59, 19 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "render/material", "@text", "material", "@size", 159, 19, "@menutype", "message" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "render/shader", "@text", "shader", "@size", 159, 19, "@menutype", "message", "@is", "none" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					"args" : [ "#1", "color", "@text", "object color", "@size", 179, 19, "@is", 0 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
