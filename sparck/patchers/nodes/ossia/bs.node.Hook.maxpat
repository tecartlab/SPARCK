...
,
		...
		"globalpatchername" : "Hook_1",
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "#2", "#4", 2, "type", "@hint", "link to object to connect it to sparck transformation. It sends 'anim' message" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 384.805542000000059, 195.5, 48.0, 30.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 224.666655999999989, 310.0, 38.0, 22.0 ],
									"text" : "zl.reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 255.703114333333303, 111.0, 264.796885666666697, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 286.739572666666618, 192.386352968749975, 183.5, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 8.999999968749989, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 224.666655999999989, 349.31591796875, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 149.777739999999994, 109.81591796875, 89.0, 22.0 ],
									"text" : "prepend ignore"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "bang", "" ],
									"patching_rect" : [ 224.666655999999989, 259.386352968749975, 205.21875, 22.0 ],
									"text" : "bs.anim.node"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 109.81591796875, 90.0, 22.0 ],
									"text" : "sprintf %s.tfm1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 30.0, 59.81591796875, 136.0, 22.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-13", 0 ],
									"midpoints" : [ 420.385405999999989, 298.008300968750063, 496.31248933333336, 298.008300968750063, 496.31248933333336, 161.386352968749975, 296.239572666666618, 161.386352968749975 ],
									"source" : [ "obj-6", 4 ]
								}
...
,
					"patching_rect" : [ 357.805542000000059, 131.684633402343763, 89.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.638915999999995, 174.869265804687473, 62.0, 20.0 ],
					"text" : "ossia.model"
				}
...
,
					"patching_rect" : [ 80.638915999999995, 122.684633402343763, 111.5, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 226.916564999999991, 131.684633402343763, 91.25, 20.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.805542000000059, 198.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.888915999999995, 149.0, 62.0, 20.0 ],
					"text" : "pattrmarker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 35.0, 7.211303999999998, 63.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.333336000000003, 7.211303999999998, 33.0, 20.0 ],
					"text" : "done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 77.138915999999995, 206.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 222.222199000000046, 7.211303999999998, 44.0, 31.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 7.211303999999998, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 263.444336000000021, 198.0, 48.0, 30.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.916564999999991, 198.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "#0_id", "#1", "#2", "#3", "#4", "title", "Hook", "@enable_properties", 1, "@enable_body", 1, "@help", "Hook" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1.0, 52.211303999999998, 210.0, 37.788696000000002 ],
					"presentation" : 1,
