...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 87.0, 236.0, 87.0 ],
					"text" : "propertyFloating #1 (0 = body, 1 = window)\nnodeid #2\ntitle #3 \naddress #4\nfilename #5 \ncolor #6 #7 #8 #9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.5, 111.5, 66.0, 22.0 ],
					"text" : "r #2::props"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 364.5, 11.605652000000006, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.5, 52.605652000000006, 114.0, 49.0 ],
					"text" : "init #1 #2 #3 #4 #5, color #6 #7 #8 #9, openproperties #1"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@prefix", "P", "@type", "Unkown", "@flags", "float", "nomenu", "noclose", "notitle", "nozoom", "nogrow", "@window", 1 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 136.0, 6.987121499999986, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 263.0, 209.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 0.0, 25.0, 242.0, 259.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 25.0, 242.0, 259.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 242.0, 284.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 242.0, 284.0 ],
					"proportion" : 0.39,
					"varname" : "vpl_canvas"
				}
