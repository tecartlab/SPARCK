...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.5, 52.605652000000006, 257.0, 35.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@prefix", "P", "@type", "Unkown", "@flags", "float", "nomenu", "noclose", "notitle", "nozoom", "nogrow" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 1,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 25.0, 242.0, 284.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "bs.node.SceneCapture.p.maxpat",
