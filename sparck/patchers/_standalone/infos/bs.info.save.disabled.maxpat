...
,
		...
		"style" : "",
		"subpatcher_template" : "",
		"title" : "Sorry, Saving is disabled",
		"boxes" : [ 			{
				"box" : 				{
					"id" : "obj-16",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 161.0, 227.0, 58.0, 21.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 161.0, 289.0, 74.0, 21.0 ],
					"style" : "",
					"text" : "prepend title"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 161.0, 259.0, 145.0, 21.0 ],
					"style" : "",
					"text" : "\"Sorry, Saving is disabled\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.5, 44.0, 70.0, 21.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 94.0, 308.0, 105.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 137.0, 61.0, 99.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 137.0, 341.0, 127.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 123.0, 137.0, 76.0, 86.0 ],
									"style" : "",
									"text" : "nozoom, nominimize, nomenu, noclose, nogrow, done"
								}
...
,
					"patching_rect" : [ 25.5, 303.0, 94.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.5, 159.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.5, 413.5, 100.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 118.0, 96.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 118.0, 108.0, 100.0, 20.0 ],
					"style" : "",
					"text" : "sigh..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 159.0, 46.0, 21.0 ],
					"style" : "",
					"text" : "wclose"
				}
