...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "address or bang to get last store value",
					"id" : "obj-8",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 83.0, 25.0, 25.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 51.0, 247.0, 22.0 ],
					"style" : "",
					"text" : "bs.msg.util.key.receive @title #1 @out #2 #3"
				}
